...
The design/strategy docs live in a **separate documentation repo**, not in this repo — `../documentation/turnlog/` (`turnlog-deep-dive.md`, `roadmap.md`, `design-system.md`, `landing-prd.md`, `turnlog-feature-brainstorm.md`). The full product spec, strategy, and rationale live in `../documentation/turnlog/turnlog-deep-dive.md`. Read it before making architectural decisions — most big questions are already settled there (note: its paid-model sections are historical; Turnlog is now free/MIT). The **marketing site is a separate repo too** — `../turnlog.landing`, live at [turnlog.dev](https://turnlog.dev), auto-deployed from its `main` via Cloudflare Workers Builds; its requirements doc is `../documentation/turnlog/landing-prd.md`. (The old `site/` skeleton in this repo was removed 2026-07-11.) Key locked decisions:
